...
- (void)testDefaultManagerShouldHaveDefaultBaseURL
{
    ...
    NSString *expectedURLString = @"https://todo-api-warmup.herokuapp.com";
    // Then
...
- (void)testRequestUserCreation
{
    [self evaluateRequestBlock:^{
        ...
        XCTAssertEqualObjects([returnedObjects.firstObject userId], @4);
        XCTAssertEqualObjects([returnedObjects.firstObject firebaseKey], @"123123123");
    }];
}
